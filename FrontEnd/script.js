...
const user = {
  ...
  fname: "Nasmeen",
  image:
    "https://scontent.fbkk22-8.fna.fbcdn.net/v/t39.30808-6/337699838_218151764202341_7243774399398942615_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeEOqiylVCSDVBVQefcyaE3XqgVg00B9XgeqBWDTQH1eBzdB3laYUtsH6tObcjmhcwgB8Wk0L3W9eQPCqJSNxUGD&_nc_ohc=4YRcdj1LvJ4AX-HQ5wz&_nc_zt=23&_nc_ht=scontent.fbkk22-8.fna&oh=00_AfDFmS3v2uABjVOR_aYmBP9Qw5x2Uu99ItPXv5VAUSHj-g&oe=644768F4",
};
...
const messageList = [
  {
    ...
    fname: "Neo",
    imageProfile:
      "https://scontent.fbkk22-4.fna.fbcdn.net/v/t39.30808-6/315982233_2209647319214449_3417131465598011782_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeFVEK9R6K9ijG3YcQzqWYn9aVa_1qnKR2lpVr_WqcpHaSQvVLc_Sbr21FQ7OhAsRw0AQaJX3RbN1n9HJIYkS1w8&_nc_ohc=xUlzjVA5iTQAX9GUHxa&_nc_zt=23&_nc_ht=scontent.fbkk22-4.fna&oh=00_AfBTYa_MkcgnQwE7fthLsIVwrq6MXoxdr_gysGM-IHKx5A&oe=64466E8A",
    message:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum in ligula id dolor dictum elementum a quis lacus. Nunc et odio risus. Proin a tincidunt felis, at vehicula nunc.",
    imageMessage: null,
    time: "10:30 AM",
    type: "text",
  },
  {
    ...
    fname: "Byte",
    imageProfile:
      "https://mpics.mgronline.com/pics/Images/565000005465502.JPEG",
    message: "What?",
    imageMessage: null,
    time: "10:31 AM",
    type: "text",
  },
  {
    ...
    fname: "Oak",
    imageProfile:
      "https://www.infoquest.co.th/wp-content/uploads/2023/04/DB741F1632A8EF3F68BD431640A4B813.jpg",
    message:
      "Vestibulum in ligula id dolor dictum elementum a quis lacus. Nunc et odio risus. Proin a tincidunt felis, at vehicula nunc.",
    imageMessage: null,
    time: "10:35 AM",
    type: "text",
  },
...
function renderMessage(message) {
  ...
  li.innerHTML = `
        <div class="chat-body ${
          message.userId == user.userId ? "self" : "other"
        }" >
            <h6>${message.fname}</h6>
            <div style="display: flex; align-items: center;">
                ...
                <div class="square ${
                  message.userId == user.userId ? "self" : "other"
                }" style="display: inline-block;">${content}</div>
            </div>
        </div>
    `;
